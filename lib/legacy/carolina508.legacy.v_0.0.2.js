...
// Report CSS
$(carolina508_id).css({'background-color':carolina508_bg_hex,'margin-top':'0px','min-height':'200px','border-top':'5px solid #001F3F','border-bottom':'2px dashed #001F3F','font-size':'14px','color':'#000','font-family': 'Arial, Helvetica, sans-serif','padding-bottom':'200px'});
