...
$('a').each(function(index, value){
   ...
   if ($(this).has("img").length) {
     var image_code = $(this).clone().wrap('<p>').parent().html();
     if (anchor["text"].length > 0) {
       anchor["text"] += '<br>' + 'IMAGE SHOWN AS LINK';
     } else {
       anchor["text"] += ' ** IMAGE DISPLAYED **';
     }
   }
...
$(carolina).css({'background-color':'#fdece2','margin-top':'0px','min-height':'200px','border-top':'5px solid #4C6881','font-size':'14px','color':'#000','padding':'5px 100px 120px 100px','font-family': 'Arial, Helvetica, sans-serif'});
$(carolina).append('<div class="carolina-title">Carolina508 <i>Legacy</i> Report </div>');
$(".carolina-title").css({'font-size':'28px','margin-bottom':'40px','color':'#666','border-bottom':'2px dashed #D59B76','padding':'20px 0px 10px'});
...
// Forms Tag Info
$(carolina).append('<div class="carolina-section"><div id="carolina-form-section"></div></div>');
$('#carolina-form-section').append('<table class="fixed-layout"><tr><td class="section-title border-B2B5C3" id="html-form-name"></td><td class="border-B2B5C3" rowspan="2"></div><textarea disabled="true" class="carolina-code-inline height-100" id="image-tag-example2"></textarea></td></tr><tr><td id="html-form-information" class="section-information border-B2B5C3"></td></tr></table>');
$( "#html-form-name").html("html forms");
$( "#html-form-information").html("1. Images with alt='' are ignored by screen readers as they are considered decorative. <br><br> 2. Limit alt(alternative) text eplanation to 125 characters. Jaws treats it different if it exceeds.");
$('#carolina-form-section').append('<table class="fixed-layout" id="image-report"><tr class="white-background"><th class="border-B2B5C3-top-none padding-10 text-center report-srno">#</th><th class="border-B2B5C3-top-none padding-10 text-center report-image-preview">Form Action</th><th class="border-B2B5C3-top-none padding-10 text-center image-description">Alternate Text Description</th><th class="border-B2B5C3-top-none padding-10 text-center report-image-length">Alternate Text Length</th><th class="border-B2B5C3-top-none padding-10 text-center report-image-link">Is this image a link?</th><th class="border-B2B5C3-top-none padding-10 text-center report-image-size">Native Image Size<br><span class="supressed-text">Height and  Width in px</span></th><th class="border-B2B5C3-top-none padding-10 text-center report-image-size">Current Image Size<br><span class="supressed-text">Height and  Width in px</span></th><th class="border-B2B5C3-top-none padding-10 text-center code-link">Code</th></tr></table>');
...
$(".section-title").css({'width':'350px','text-align':'center','background-color':'#D59B76','font-size':'24px'});
...
$(".carolina-code-inline").css({'font-family':'"Courier New", Courier, monospace','width':'100%','max-width':'100%','border':'none','background-color':'#efefef','word-break': 'break-word','padding-left': '20px','padding-right': '20px'});
