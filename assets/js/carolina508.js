...
for (var i = 0; i < image_tags.length; i++) {
  $('#image-report').append('<tr class="white-background word-break"><td class="border-B2B5C3-top-none padding-10 text-center report-srno">'+(i+1)+'</td><td class="border-B2B5C3-top-none padding-10 text-center report-image-preview">'+image_tags[i].code+'</td><td class="border-B2B5C3-top-none padding-10 text-center image-description">'+image_tags[i].alt_text+'</td><td class="border-B2B5C3-top-none padding-10 text-center report-image-length">'+image_tags[i].alt_text_length+'</td><td class="border-B2B5C3-top-none padding-10 text-center report-image-link">??</td><td class="border-B2B5C3-top-none padding-10 text-center report-image-size">'+image_tags[i].native_hw+'</td><td class="border-B2B5C3-top-none padding-10 text-center report-image-size">'+image_tags[i].current_hw+'</td><td class="border-B2B5C3-top-none padding-10 anchor-url text-center image-report-code" id="image-report-data-'+(i+1)+'">&#9661;</td></tr><tr class="white-background word-break white-background code-data-row border-B2B5C3-top-none" id="image-report-code-'+(i+1)+'"><td colspan="8"><textarea disabled="true" class="carolina-code-inline white-background border-B2B5C3-top-none">'+image_tags[i].code+'</textarea></td></tr>');
}
